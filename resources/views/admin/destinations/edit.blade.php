            ...
            <div class="card-body">
                <form action="{{ route('admin.destinations.update', $destination->id) }}" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="price" placeholder="{{ __('price') }}" name="price" value="{{ old('province', $destination->price) }}" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="number" placeholder="{{ __('number') }}" name="number" value="{{ old('number', $destination->number) }}" />
                    </div>
                    <div class="form-group">
